...
const BoxOptions = ({
  ...
  return (
    <Box className="modalFullPostModalLocationPhotoPostBoxOptions">
      {!isLoading ? (
        <>
          <div className="modalFullPostModalLocationPhotoPostDivOptions">
            ...
            myCityLocation.length === 0 ? (
              <h6 className="modalFullPostModalLocationPhotoPostNoResults">Not more results</h6>
            ) : null}
          </div>
        </>
      ) : (
        <CircularProgress className="modalFullPostModalLocationPhotoPostRelaod" />
      )}
    </Box>
  );
};
