...
const Countries = ({
  ...
  return (
    <button onClick={() => slectCountry()}  className="modalFullPostModalLocationPhotoPostButton">
    <Card>
      <CardHeader
        title={<h6 className="modalFullPostModalLocationPhotoPostName">{item.country}</h6>}
      />
    </Card>
  </button>
  );
