...
import "../../../../../../Css/Post/Create/ModalCreatePhotoPost/ModalLocationPhotoPost.css"
...
const ModalLocation = ({ location, setLocation, setModalLocation }) => {
  ...
  return (
    <>
      <div
        className="modal show fade d-block modalLocationPhotoPostLocation"
        tabIndex="-1"
      >
        <div className="modal-dialog model-border model-block">
          <div className="modal-content">
            ...
            <hr className="modalLocationPhotoPostHr" />
            <div>
              <Delete
                setLocation={setLocation}
                setModalLocation={setModalLocation}
