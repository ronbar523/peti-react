...
const Send = ({
  ...
  return (
    <div className="modalFullPostCommentCreateDivButton2">
      {!isLoadingSend ? (
        <Button
          variant={description === "" ? "outlined" : "contained"}
          endIcon={<SendIcon sx={{ fontSize: "12px" }} />}
          className="modalFullPostCommentCreateButton2"
          sx={{
            textTransform: "unset",
          }}
          onClick={() => send()}
        ...
        >
          <h6 className="modalFullPostCommentCreateButtonText2">Send</h6>
        </Button>
      ) : (
        <LoadingButton
