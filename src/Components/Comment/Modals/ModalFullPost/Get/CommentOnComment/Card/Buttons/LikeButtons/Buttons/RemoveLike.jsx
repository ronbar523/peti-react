...
const RemoveLike = ({ commentItem2, countLikes, setCountLikes, setLike, setModalPostDeleted,
  ...
  return (
    <button
      className={
        enterMouse
          ? "modalFullPostCommentGetLikeButton2 modalFullPostCommentGetTextDescription1 text-primary"
          : "modalFullPostCommentGetLikeButton2 text-primary"
      }
